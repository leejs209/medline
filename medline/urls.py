...
urlpatterns = [
    ...
    path('medicalhub', medicalhub.home, name='medicalhub_pending_consult'),
    path('medicalhub/pending', medicalhub.ongoing, name='medicalhub_ongoing_consult'),
    path('medicalhub/finished', medicalhub.finished, name='medicalhub_finished_consult'),
